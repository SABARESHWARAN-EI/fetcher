...
<title>FETCHER - FORGOT PASSWORD</title>
<link
...
<input type="hidden" id="status" value="<%=request.getAttribute("status") %>">
				...
				<form class="card mt-4" action="forgotPassword" method="POST">
					...
					<div class="card-footer">
						<button class="btn btn-success" type="submit">Get New
							Password</button>
						<button class="btn btn-danger" id="back_to_login" type="submit" onclick="login.jsp">Back to
							Login</button>
	...
	if(status =="failed")
		swal("Ooops!","Email id is not registered! Try valid email id!","error");
	</script>
</body>
</html>